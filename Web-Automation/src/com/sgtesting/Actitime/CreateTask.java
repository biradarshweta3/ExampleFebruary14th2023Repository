		...
		public class CreateTask {
			...
			private static void customer()
			{
				try
				{
					...
					Thread.sleep(3000);
					oBrowser.findElement(By.id("customerLightBox_nameField")).sendKeys("shree");
			...
			private static void task()
			{
				try
				{
					...
					//Thread.sleep(2000);
					oBrowser.findElement(By.xpath("//*[@id=\"createTasksPopup_createTasksTableContainer\"]/table/tbody/tr[1]/td[1]/input")).sendKeys("Complete programs");
					//Thread.sleep(2000);
